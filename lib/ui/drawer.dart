...
import 'package:auto_call/home.dart';
import 'package:auto_call/pages/call_queue.dart';
    ...
    return Drawer(
        child: new Column(
          ...
          children: <Widget>[
            new DrawerHeader(
                child: new Center(
                    child: new Text('Your Favorite Robot Assistant', textScaleFactor: 1.5)),
...
//          ),
            ...
            new ListTile(
              ...
              title: new Text('Dynamic Table 2', textScaleFactor: textScale),
              onTap: () {
...
//          ),
            ...
            new Expanded(
              ...
              child: new Align(
                  ...
                  child: new ListTile(
                    title: new Text('Copyright 2020 | Brandon Kunkel',
  ...
  void navigatorUpdate(BuildContext context, String desiredRoute) {
    ...
    Navigator.of(context).pushNamedAndRemoveUntil(
        desiredRoute,
        (route) => route.isCurrent && route.settings.name == desiredRoute
            ? false
            : true);
  }
}
