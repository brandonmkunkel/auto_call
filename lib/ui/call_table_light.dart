...
class _CallTableState extends State<CallTableLight> {
  ...
  Widget rowBuilder(BuildContext context, int i) {
    return ListTile(
        ...
        trailing: CalledText(text: widget.phoneList.people[i].name, called: widget.phoneList.people[i].called),
        title: CalledText(text: widget.phoneList.people[i].phone, called: widget.phoneList.people[i].called),
