  ...
  Widget build(BuildContext context) {
    return Text(text,
        style: TextStyle(
          ...
          fontSize: (Theme.of(context).textTheme.bodyText2?.fontSize as double) * 1.2,
...
class CalledText extends StatelessWidget {
  ...
  const CalledText({Key? key, required this.text, required this.called, this.align = TextAlign.left}) : super(key: key);
