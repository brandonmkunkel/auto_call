                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // ListTile(leading: Text("Title:"), title: TextFormField(controller: controller1, focusNode: _focusNode1, decoration: InputDecoration(contentPadding: EdgeInsets.symmetric(vertical: 0, horizontal: 10), border: OutlineInputBorder(), hintText: 'Title'),)),
                              // ListTile(leading: Text("Stuff:"), title: TextFormField(controller: controller2, focusNode: _focusNode2, decoration: InputDecoration(contentPadding: EdgeInsets.symmetric(vertical: 0, horizontal: 10), border: OutlineInputBorder(), hintText: '..........'),)),
                            ],
                          ),
                        )),
                  ],
